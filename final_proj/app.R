    ...
    tabPanel("Statistical Analysis", 
            sidebarLayout(sidebarPanel(
                ...
                mainPanel(
                     ...
                     # p("This graph plots the proportion of a county's population that is white on the x-axis with 
                     #    the percentage of a county's population that is registered as an organ donor."),
       ...
       joined_data %>%
           ...
           labs(x = "% of Population Registered as an Organ Donor", 
                ...
                color = case_when(
                    ...
                    input$plot_type == "Race" ~ "Percentage of County 
